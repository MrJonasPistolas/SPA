...
namespace EXM.Infrastructure.Services.Identity
{
    public class IdentityService : ITokenService
    {
        ...
        public IdentityService(
            UserManager<EXMUser> userManager, RoleManager<EXMRole> roleManager,
            IOptions<AppConfiguration> appConfig, SignInManager<EXMUser> signInManager)
        {
        ...
        private async Task<string> GenerateJwtAsync(EXMUser user)
        {
            var token = GenerateEncryptedToken(GetSigningCredentials(), await GetClaimsAsync(user));
            return token;
        }

        private async Task<IEnumerable<Claim>> GetClaimsAsync(EXMUser user)
        {
