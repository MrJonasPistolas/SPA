...
using EXM.Infrastructure.Specifications;
...
namespace EXM.Infrastructure.Services.Identity
{
    public class UserService : IUserService
    {
        ...
        private async Task<string> SendVerificationEmail(EXMUser user, string origin)
        {
        ...
        public async Task<string> ExportToExcelAsync(string searchString = "")
        {
            ...
            var result = await _excelService.ExportAsync(users, sheetName: "Users",
                mappers: new Dictionary<string, Func<EXMUser, object>>
                {
                    { "Id", item => item.Id },
