using EXM.Common.Entities.Audit;
...
{
    public abstract class AuditableContext : IdentityDbContext<EXMUser, EXMRole, string, IdentityUserClaim<string>, IdentityUserRole<string>, IdentityUserLogin<string>, EXMRoleClaim, IdentityUserToken<string>>
    {
